...
Gpio MG90S_SERVO(Gpio::PORT0, 23, Gpio::PUSHPULL, Gpio::OUTPUT, Gpio::HIGH);
...
#ifdef I2C2_PINS
Gpio I2C2_SDA(Gpio::PORT0, 2, Gpio::OPENCOLECTOR, Gpio::OUTPUT, Gpio::LOW);
Gpio I2C2_SCL(Gpio::PORT0, 3, Gpio::OPENCOLECTOR, Gpio::OUTPUT, Gpio::LOW);
#endif // I2C2_PINS
...
Gpio SPI0_DEBUG_SCK(Gpio::PORT0, 9, Gpio::PUSHPULL, Gpio::OUTPUT, Gpio::HIGH);
Gpio SPI0_DEBUG_MOSI(Gpio::PORT0, 10, Gpio::PUSHPULL, Gpio::OUTPUT, Gpio::HIGH);
Gpio SPI0_DEBUG_MISO(Gpio::PORT0, 11, Gpio::PUSHPULL, Gpio::OUTPUT, Gpio::HIGH);
Gpio SPI0_DEBUG_SSEL0(Gpio::PORT0, 1, Gpio::PUSHPULL, Gpio::OUTPUT, Gpio::HIGH);
Gpio SPI0_DEBUG_SSEL1(Gpio::PORT0, 14, Gpio::PUSHPULL, Gpio::OUTPUT, Gpio::HIGH);
#endif // SPI0_DEBUG_PINS

#ifdef SPI1_DEBUG_PINS
Gpio SPI1_DEBUG_SCK(Gpio::PORT0, 19, Gpio::PUSHPULL, Gpio::OUTPUT, Gpio::HIGH);
Gpio SPI1_DEBUG_MOSI(Gpio::PORT0, 22, Gpio::PUSHPULL, Gpio::OUTPUT, Gpio::HIGH);
Gpio SPI1_DEBUG_MISO(Gpio::PORT0, 21, Gpio::PUSHPULL, Gpio::OUTPUT, Gpio::HIGH);
Gpio SPI1_DEBUG_SSEL0(Gpio::PORT0, 20, Gpio::PUSHPULL, Gpio::OUTPUT, Gpio::HIGH);
Gpio SPI1_DEBUG_SSEL1(Gpio::PORT0, 18, Gpio::PUSHPULL, Gpio::OUTPUT, Gpio::HIGH);
